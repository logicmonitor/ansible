...
options:
  ...
  device_display_name:
    description:
      ...
      - If both device_id and device_display_name are undefined, we will attempt to perform a best-guess lookup based on the current host's FQDN.
      - Implicit host lookup is not guaranteed to be reliable and will only be used as a last resort.
    required: false
    default: null
  device_id:
    description:
